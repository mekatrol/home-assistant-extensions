...
declare global {
  ...
  interface Window {
    ...
    ShadyCSS: {
      ...
      prepareTemplate(templateElement: string, elementName: string, elementExtension: string): void;
      styleElement(element: HTMLElement): void;
      styleSubtree(element: HTMLElement, overrideProperties: any): void;
      styleDocument(overrideProperties: any): void;
      getComputedStyleValue(element: HTMLElement, propertyName: string): void;
    };
  }
  // for fire event
